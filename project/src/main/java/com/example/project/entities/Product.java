...
public class Product implements Serializable {
    ...
    // @Transient //ele nao tenta interpretar
    @ManyToAny
    @JoinTable(name = "tb_product_category", // nome da tabela de associacao no banco de dados
            joinColumns = @JoinColumn(name = "product_id"), // nome da minha tabela PK
